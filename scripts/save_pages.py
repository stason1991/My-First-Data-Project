...
TARGET_ROLES = {
    ...
    9: {"queries": ["главный клиентский менеджер", "top-продавец банк", "ведущий менеджер продаж банк", "главный специалист розничного бизнеса", "senior sales manager bank"], "desc": "Главный менеджер продаж", "grades": False},
    ...
    17: {"queries": ["менеджер мобильного резерва банк", "универсальный специалист банк", "подменный менеджер банк", "сотрудник мобильной группы банк"], "desc": "Менеджер мобильного резерва", "grades": False},
    18: {"queries": ["главный менеджер мобильного резерва банк", "ведущий специалист мобильного резерва", "антикризисный менеджер отделений"], "desc": "Главный менеджер мобильного резерва", "grades": False},
    19: {"queries": ["заместитель руководителя офиса банк", "ЗРО банк", "заместитель директора отделения банк", "операционный директор дополнительного офиса"], "desc": "Заместитель руководителя офиса", "grades": False},
    20: {"queries": ["руководитель офиса банк", "директор отделения банк", "директор ДО банк", "управляющий дополнительным офисом", "начальник отделения банка"], "desc": "Руководитель офиса (P&L)", "grades": False},
    ...
    26: {"queries": ["аналитик рисков банк", "риск-аналитик"], "desc": "Аналитик рисков (Кредитные/Рыночные)", "grades": False},
    ...
    29: {"queries": ["комплаенс контроль банк", "финансовый мониторинг комплаенс"], "desc": "Специалист по комплаенсу (115-ФЗ)", "grades": False},
    30: {"queries": ["информационная безопасность банк"], "desc": "ИБ", "grades": False},
