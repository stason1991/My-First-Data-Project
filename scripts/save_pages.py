...
# Настройки сбора страниц html
TARGET_PAGES = 1  # Сколько страниц выдачи обработать за запрос
OUTPUT_ROOT = (
    r"C:\Users\Asus\OneDrive\Рабочий стол\Project ML ITMO\Модуль №3 ML System Design and MFDP\MFDP\data\raw\hh_pages"
)
OUTPUT_DIR = OUTPUT_ROOT

# Укомплектованная ролевая сетка
TARGET_ROLES = {
    1: {
        "queries": [
            "специалист доставка карт",
            "выездной специалист банк",
            "представитель банк",
            "доставка банковских карт",
            "мобильный специалист банк",
            "курьер в банк",
        ],
        "desc": "Мобильный фронт / Доставка карт",
        "grades": False,
    },
    2: {
        "queries": [
            "прямые продажи банк",
            "менеджер ГПП",
            "выездной менеджер банк",
            "активные продажи банк",
            "полевой менеджер банк",
            "коммерческий лидер банк",
        ],
        "desc": "Менеджер прямых продаж (ГПП)",
        "grades": False,
    },
    3: {
        "queries": [
            "руководитель курьеров",
            "супервайзер курьеров",
            "логист курьерская служба банк",
            "координатор доставки банк",
            "начальник выездного сервиса банк",
        ],
        "desc": "Руководитель мобильного фронта",
        "grades": False,
    },
    4: {
        "queries": [
            ...
            "начальник ГПП",
            "руководитель отдела продаж банк",
            "superviser гпп",
            "тимлид активных продаж банк",
        ],
        "desc": "Руководитель ГПП / Лидер продаж",
        "grades": False,
    },
    5: {
        "queries": [
            "администратор зала банк",
            "хостес банк",
            "встречающий менеджер банк",
            "консультант зала банк",
            "администратор отделения банк",
        ],
        "desc": "Администратор зала отделений",
        "grades": False,
    },
    6: {
        "queries": [
            "операционист бэк-офис банк",
            "специалист сопровождения банк",
            "специалист бэк-офиса банк",
            "операционист отделения",
            "сервисный менеджер банк",
            "специалист операционного отдела",
        ],
        "desc": "Операционист (Сервис / Бэк-офис)",
        "grades": False,
    },
    7: {
        "queries": [
            "кассир операционист",
            "старший кассир банк",
            "заведующий кассой банк",
            "кассир отделения банк",
            "специалист по кассовым операциям",
        ],
        "desc": "Кассир-операционист отделения",
        "grades": False,
    },
    8: {
        "queries": [
            "клиентский менеджер банк",
            "менеджер розничных продаж банк",
            "специалист окон банк",
            "менеджер по работе с физическими лицами",
            "консультант по продажам банк",
            "фронт-менеджер банк",
        ],
        "desc": "Менеджер по продажам (Масс-Фронт)",
        "grades": False,
    },
    9: {
        "queries": [
            ...
            "top-продавец банк",
            "ведущий менеджер продаж банк",
            "главный менеджер розничного бизнеса",
            "senior sales manager bank",
        ],
        "desc": "Главный менеджер продаж",
        "grades": False,
    },
    10: {
        "queries": [
            "операционист премиум сегмент",
            "сервис VIP клиентов банк",
            "премиальное обслуживание банк",
            "персональный ассистент VIP банк",
            "менеджер premium сегмента",
        ],
        "desc": "Premium-операционист розницы",
        "grades": False,
    },
    11: {
        "queries": [
            "персональный менеджер private",
            "инвестиционный консультант банк",
            "премиум менеджер bank",
            "финансовый консультант private banking",
            "управляющий активами банк",
            " wealth management bank",
        ],
        "desc": "Персональный менеджер VIP / Private",
        "grades": False,
    },
    12: {
        "queries": [
            "привлечение юридических лиц банк",
            "клиентский менеджер b2b банк",
            "менеджер по развитию корпоративного бизнеса",
            "хантер b2b банк",
            "активные продажи юр лицам банк",
            "открытие рко банк",
        ],
        "desc": "Менеджер по привлечению ЮЛ (Hunter)",
        "grades": False,
    },
    13: {
        "queries": [
            "обслуживание юридических лиц банк",
            "сопровождение b2b банк",
            "фермер b2b банк",
            "аккаунт менеджер b2b банк",
            "менеджер малого и среднего бизнеса банк",
            "сопровождение малого бизнеса",
        ],
        "desc": "Менеджер по обслуживанию ЮЛ (Farmer)",
        "grades": False,
    },
    14: {
        "queries": [
            "руководитель направления b2b банк",
            "начальник отдела корпоративного бизнеса",
            "директор департамента юридических лиц банк",
            "руководитель малого бизнеса банк",
        ],
        "desc": "Руководитель направления ЮЛ",
        "grades": False,
    },
    15: {
        "queries": [
            ...
            "менеджер по ипотеке",
            "эксперт по ипотечным сделкам",
            "андеррайтер ипотеки",
        ],
        "desc": "Ипотечный менеджер отделений",
        "grades": False,
    },
    16: {
        "queries": [
        ...
        "desc": "Руководитель ипотечного отдела / ЦИК",
        "grades": False,
    },
    17: {
        "queries": ["клиентский менеджер группы резерва банк", "группа резерва", "подменный менеджер банк"],
        "desc": "Менеджер группы резерва",
        "grades": False,
    },
    18: {
        "queries": [
            "главный менеджер резерва банк",
            "ведущий менеджер группы резерва",
            "главный подменный менеджер",
            "ведущий подменный менеджер",
        ],
        "desc": "Главный менеджер группы резерва",
        "grades": False,
    },
    19: {
        "queries": ["заместитель руководителя офиса банк", "заместитель директора отделения банк"],
        "desc": "Заместитель руководителя офиса",
        "grades": False,
    },
    20: {
        "queries": [
            "руководитель офиса банк",
            "директор отделения банк",
            "директор дополнительного офиса банк",
            "управляющий дополнительным офисом",
            "начальник отделения банка",
        ],
        "desc": "Руководитель офиса (P&L)",
        "grades": False,
    },
    21: {
        "queries": [
            "Data Scientist банк",
            "Machine Learning Engineer банк",
            "ML Engineer",
            "Аналитик данных",
            "Data аналитик",
            "Data engineer",
        ...
        "desc": "Data Scientist / ML Engineer",
        "grades": True,
    },
    22: {
        "queries": ["Data Engineer банк", "инженер данных банк"],
        "desc": "Data Engineer / DWH Developer",
        "grades": True,
    },
    ...
    26: {
        "queries": ["аналитик рисков банк", "риск-аналитик", "risk", "риск"],
        "desc": "Аналитик рисков (Кредитные/Рыночные)",
        "grades": False,
    },
    27: {"queries": ["андеррайтер банк", "андеррайтер кредитный"], "desc": "Андеррайтер (b2c / b2b)", "grades": False},
    28: {
        "queries": ["инвестиционный аналитик", "аналитик инвестиционного департамента"],
        "desc": "Инвестиционный аналитик (CFA/ФСФР)",
        "grades": False,
    },
    29: {
        "queries": ["комплаенс контроль банк", "финансовый мониторинг комплаенс", "комплаенс офицер", "AML officer"],
        "desc": "Специалист по комплаенсу (115-ФЗ)",
        "grades": False,
    },
    ...
    31: {
        ...
        "desc": "HR-специалист / Рекрутер / HRBP",
        "grades": False,
    },
}
...
# Интерактивный цикл по всем классам
for class_id, role_info in TARGET_ROLES.items():
    ...
    for search_query in final_queries_pool:
        ...
        driver.get(
            "https://spb.hh.ru/search/vacancy?text=&search_field=name&search_field=company_name&search_field=description&enable_snippets=false&hhtmSourceLabel=vacancy_search_list&L_save_area=true"
        )
        ...
        try:
            ...
            print(f" Ошибка авто-ввода: {search_error}")
        ...
        for page in range(1, TARGET_PAGES + 1):
                    ...
                    if href:
                        ...
                        if "/vacancy/" in clean_href and clean_href not in vacancy_links:
                            ...
                            if vacancy_id.isdigit():
                                ...
                                try:
                                    card_element = el.find_element(
                                        By.XPATH,
                                        './ancestor::div[contains(@class, "vacancy-card") or contains(@class, "serp-item")]',
                                    )
                                ...
                                if has_retail:
                                    print(
                                        f"   [ОТКЛОНЕНО] Пропущена ритейл-вакансия ID: {vacancy_id} (найдено стоп-слово)"
                                    )
            ...
            print(
                f"Найдено {len(vacancy_links)} ЧИСТЫХ БАНКОВСКИХ вакансий на странице. Начинаем глубокое скачивание..."
            )
